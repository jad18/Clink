...
NOTE: IF YOU PULL FROM THE REMOTE REPOSITORY, YOU MUST CHANGE THE "YOUR LOCAL IP ADDRESS HERE"
STRING IN INDEX.JS TO YOUR LOCAL IP ADDRESS (IN STRING FORMAT) FOR IT TO WORK.
